    ...
    return (
        <div className='my-5 mx-6'>
            ...
            <div className='plan my-4'>
                <Link to='/' className="block p-6 max-w-sm bg-pink-600 rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <Link to='/' className="block p-6 max-w-sm bg-violet-600 rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <Link to='/' className="block p-6 max-w-sm bg-sky-500 rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-white-800 dark:border-gray-700 dark:hover:bg-gray-700">
